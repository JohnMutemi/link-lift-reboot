...
const Route = createLucideIcon("route", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
...
const Snowflake = createLucideIcon("snowflake", __iconNode$9);
const __iconNode$8 = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const Wrench = createLucideIcon("wrench", __iconNode$3);
const __iconNode$2 = [
