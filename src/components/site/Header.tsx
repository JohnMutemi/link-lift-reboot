...
const quoteLinkClass =
  "inline-flex items-center gap-2 bg-orange hover:bg-orange-600 text-white px-4 lg:px-5 xl:px-6 py-2.5 rounded-sm font-bold text-[10px] lg:text-xs uppercase tracking-widest transition-all shadow-md shadow-orange/20 shrink-0 touch-manipulation";
...
export function Header() {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-100">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 grid grid-cols-[1fr_auto] lg:grid-cols-[1fr_auto_1fr] items-center gap-3 lg:gap-8">
        <Logo />
